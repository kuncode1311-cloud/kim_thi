...
const wishList = [
  {
    text: "Chúc Kim Thi một mùa Trung Thu thật vui vẻ và đáng yêu, ăn bánh thả ga mà không lo béo nha! 🥮✨",
    img: "./assets/kt1.png",
  },
  {
    text: "Cầu chúc cho mọi điều ước nhỏ bé và dễ thương của Kim Thi đều sớm trở thành hiện thực nhé! 🐰⭐",
    img: "./assets/kt2.png",
  },
  {
  ...
  {
    text: "Trung Thu vui vẻ nha Kim Thi! Chúc bạn làm việc gì cũng suôn sẻ, vạn sự hanh thông và luôn gặp may mắn! 🎉🎈",
    img: "./assets/kt4.png",
  },
  {
    text: "Mong Kim Thi mỗi ngày trôi qua đều ngập tràn niềm vui cùng những điều ngọt ngào, dễ thương! 🌸✨",
    img: "./assets/kt5.png",
  },
  {
    text: "Chúc Kim Thi mùa trăng này luôn ngập tràn may mắn, niềm vui và vạn sự như ý! 🥮🏮",
    img: "./assets/kt6.png",
  },
  {
    text: "Chúc Kim Thi lúc nào cũng lạc quan, tràn đầy nhiệt huyết, học tập và công việc luôn đạt kết quả thật xuất sắc nhé! 💚💪",
    img: "./assets/kt7.png",
  },
  {
    text: "Chúc Kim Thi có một đêm Trung Thu thật thảnh thơi, ngắm trăng phá cỗ và nụ cười luôn tỏa sáng rực rỡ nha! 🏮✨",
    img: "./assets/kt8.png",
  },
  {
    text: "Chúc Kim Thi mỗi ngày trôi qua đều bình yên, vui tươi và luôn nhận được thật nhiều yêu thương, quý mến! 🌸🍀",
    img: "./assets/kt9.png",
  },
  {
    text: "Chúc Kim Thi luôn xinh xắn, rạng ngời như ánh trăng rằm, tâm hồn an yên và nụ cười luôn rạng rỡ trên môi! 🌙✨",
    img: "./assets/kt10.png",
  },
];
